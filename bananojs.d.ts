...
declare module '@bananocoin/bananojs' {
  ...
  declare namespace bananoUtil {
     ...
     * @returns returns the hash returned by the send.
     */
    function sendAmountToNanoAccountWithRepresentativeAndPrevious(
      seed: string,
      seedIx: string,
      destAccount: string,
      amountRaw: string,
     ...
     * @returns returns the hash returned by the send.
     */
    function sendAmountToBananoAccount(
      seed: string,
      seedIx: string,
      destAccount: string,
      amountRaw: string,
     ...
     * @returns returns the hash returned by the send.
     */
    function sendAmountToNanoAccount(
      seed: string,
      seedIx: string,
      destAccount: string,
      amountRaw: string,
     ...
     */
    function changeBananoRepresentativeForSeed(
      seed: string,
      seedIx: string,
      representative: string
    ): Promise<string>;
     ...
     * @returns returns the hash returned by the change.
     */
    function changeNanoRepresentativeForSeed(
      seed: string,
      seedIx: string,
      representative: string
    ): Promise<string>;
     ...
     */
    function openBananoAccountFromSeed(
      seed: string,
      seedIx: string,
      representative: string,
     ...
     * @returns returns the hash returned by the open.
     */
    function openNanoAccountFromSeed(
      seed: string,
      seedIx: string,
      representative: string,
      pendingBlockHash: string,
  ...
  declare namespace depositUtil {
    ...
    function receive(
      loggingUtil: any,
      bananodeApi: bananodeApi,
      account: string,
      privateKey: string,
      representative: string,
      specificPendingBlockHash: string | null,
     ...
     * @returns returns the response returned by the receive.
     */
    function receiveNanoDepositsForSeed(
      seed: string,
      seedIx: string,
      representative: string,
